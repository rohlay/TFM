...
python ingest.py --model nomic-embed-text --source ati --threads 1
python ingest.py --model nomic-embed-text --source book

:: MXBAI-Embed-Large-V2
python ingest.py --model mxbai-embed-large --source ati --threads 1
python ingest.py --model mxbai-embed-large --source book

:: BGE-M3
python ingest.py --model bge-m3 --source ati --threads 1
python ingest.py --model bge-m3 --source book

:: Qwen3-Embedding (0.6B)
python ingest.py --model qwen3-embedding --source ati --threads 1
...
python ingest.py --model jina-v4 --source ati --threads 1
python ingest.py --model jina-v4 --source book

:: Gemma-2-9B-IT (As an embedding model)
python ingest.py --model gemma2 --source ati --threads 1
